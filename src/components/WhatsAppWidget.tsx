...
export default function WhatsAppWidget() {
  // Use the international format by adding the Ghana country code (+233) for the 024 number
  const whatsappUrl = 'https://wa.me/233245259221';
  ...
  return (
    ...
    >
      ...
      <span className="absolute w-full h-full rounded-full bg-[#25D366] opacity-30 animate-ping pointer-events-none" />
    </motion.a>
  );
}
